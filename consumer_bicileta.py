...
print(f"ESPERANDO DATOS DE BICICLETA en '{topic_kafka}'...")
...
try:
    while True:
        ...
        if 'Bicicleta' in mensaje:
            
            # Nombre del archivo: Bicicleta/dato_unico.json
            nombre_archivo = f"Bicicleta/dato_{uuid.uuid4()}.json"
